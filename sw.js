const VERSION='zombie-shell-v36.4.4';
const APP_SHELL=['./','./index.html','./style.css?v=36.4.4','./app.js?v=36.4.4','./manifest.webmanifest?v=36.4.4','./zombie-icon-180.png?v=15','./zombie-icon-192.png?v=15','./zombie-icon-512.png?v=15'];
