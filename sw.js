const VERSION='zombie-shell-v36.5.1';
const APP_SHELL=['./','./index.html','./style.css?v=36.5.1','./app.js?v=36.5.1','./manifest.webmanifest?v=36.5.1','./zombie-icon-180.png?v=15','./zombie-icon-192.png?v=15','./zombie-icon-512.png?v=15'];
